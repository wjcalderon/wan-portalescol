<template>
  <section :class="['medical-network-result-container', isMobile ? 'mobile' : '']" id="medical-network-result-container"
    v-show="show_results">
    <div class="cog--mq">
      <div class="actions row">
        ...
        ]" @click="searchList" :disabled="show_no_results">
          Ver listado
        </button>
        <button :class="[
          'show-map',
        ...
        ]" @click="searchMap" :disabled="show_no_results">
          Ver mapa
        </button>
      ...
      <component :is="showResults" :results="results" :pager="pager" :isMobile="isMobile"></component>
