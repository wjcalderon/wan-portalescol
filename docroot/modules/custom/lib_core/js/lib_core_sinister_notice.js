;(function ($) {
  Drupal.behaviors.sinister_notice = {
    attach: function (context, settings) {
        ...
        $ctn_form.find('.cities-sinisters-notices').keyup(function () {
          if ($(this).val().length > 1) {
            ...
            var $selectHidden = $(this)
              ...
              .next('.hidden-select')
              .find('#' + cdatafh)
            //cities_autocomplete($(this), $selectHidden, $(this).val());
          }
        })
      }

      /**
       * [cities_autocomplete description]
      ...
      /*function cities_autocomplete($element, $selectHidden, name_city) {
       ...
       * @return {[type]}              [description]
       */
      function states_fields($active_form) {
        // Death number
        $active_form
          .find('#00N4A00000Fkhd2')
          .parent('.form-item')
          .addClass('is-hidden')
        $active_form.find('#00N4A00000FkWrl').change(function () {
          if ($(this).val() == 'Si') {
            $active_form
              .find('#00N4A00000Fkhd2')
              .parent('.form-item')
              .removeClass('is-hidden')
            $active_form.find('#00N4A00000Fkhd2').removeClass('ignore')
          } else {
            $active_form
              .find('#00N4A00000Fkhd2')
              .parent('.form-item')
              .addClass('is-hidden')
            $active_form.find('#00N4A00000Fkhd2').addClass('ignore')
            $active_form.find('#00N4A00000Fkhd2').val('')
          }
        })

        // Wounded number
        $active_form
          .find('#00N4A00000Fkhd7')
          .parent('.form-item')
          .addClass('is-hidden')
        $active_form.find('#00N4A00000FkWrg').change(function () {
          if ($(this).val() == 'Si') {
            $active_form
              .find('#00N4A00000Fkhd7')
              .parent('.form-item')
              .removeClass('is-hidden')
            $active_form.find('#00N4A00000Fkhd7').removeClass('ignore')
          } else {
            $active_form
              .find('#00N4A00000Fkhd7')
              .parent('.form-item')
              .addClass('is-hidden')
            $active_form.find('#00N4A00000Fkhd7').addClass('ignore')
            $active_form.find('#00N4A00000Fkhd7').val('')
          }
        })
      }
          ...
          case 'insured':
            $("input[name='driver_same_insure']", context).click(function () {
              if ($(this).val() == 'Si') {
                ...
                // GRUPO DE CAMPOS - CONDUCTOR -> ASEGURADO
                // Tipo de documento
                $active_form.find('.insured_info-insured_id').val('').focusout()
                // Número de identificacion
                $active_form
                  .find('.insured_info-insured_id_num')
                  .val('')
                ...
                function () {
                  if ($(this).val() == 'Si') {
                    ...
                    $active_form
                      ...
                      .val(
                        $active_form
                          .find('.affect_vehic_own-third_phone')
                          .val(),
                      )
                      .focus()
                    // Email
                    $active_form
                      ...
                      .val(
                        $active_form
                          .find('.affect_vehic_own-third_email')
                          .val(),
                      )
                      .focus()
                    // Direccion
