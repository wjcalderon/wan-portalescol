...
class SinisterNotifthirdAffectedd extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['step1']['ins_veh_info'][$report_type] = [
      ...
      '#options' => [
        'DOPUA' =>
        'Daños ocasionados por un asegurado de HDI Seguros (Es usted tercero afectado)',
      ],
      '#attributes' => [
        'id' => $report_type,
      ],
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->libCoreController->webformRestPost('aviso_de_siniestro_tercero_afect', $values);
  }
