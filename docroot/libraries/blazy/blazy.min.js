...
(function (q, m) {
  ...
  function m(b) {
    for (let c = b._util, a = 0; a < c.count; a++) {
      let d = c.elements[a],
        e;
      a: {
        let g = d;
  ...
  function E(b) {
    ...
    for (let a = b.length; a--; c.unshift(b[a]));
    return c;
  }
  function C(b) {
    f.bottom =
  ...
  function l(b, c) {
    if (b && c) for (let a = b.length, d = 0; d < a && !1 !== c(b[d], d); d++);
  }
  function D(b, c, a) {
    let d = 0;
    return function () {
  ...
  return function (b) {
    if (!document.querySelectorAll) {
      let c = document.createStyleSheet();
