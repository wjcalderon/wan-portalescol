 ...
 * its location.
 */
// $settings['config_sync_directory'] = $app_root . '/' . $site_path . '/config';
// $settings['config_vcs_directory'] = $app_root . '/' . $site_path . '/config';
 ...
 * @endcode
 */
$settings['hash_salt'] = 'v4SUywggik5Uh9oDtLgRwUCEGeUsrLZAGK257PJdItRDjOrusanrI0McBgjHEDnKPdgJNuWBpg';
