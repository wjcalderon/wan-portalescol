 ...
 * @endcode
 */
$settings['hash_salt'] = 'F1EffTcvBW9Gl-hzLgRRIXy9TpFXTpJZt9XiKIdSUD29O02eODPOoyspIk_Sp25LjP8Wgs5GQQ';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_libertyseg_prod_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_libertyseg_prod_default.inc';
  $settings['hash_salt'] = 'FEYVmDQURgBeAncyhZbJvRRsWzHMWXSZajdQjMLDPSyjbKdjjKnpbMQYWOWWoOyy';
}
// </DDSETTINGS>
