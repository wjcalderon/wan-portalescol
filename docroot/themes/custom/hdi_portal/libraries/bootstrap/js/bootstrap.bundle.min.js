...
!(function (t, e) {
  ...
  function vt(t, e) {
    let i = e.getRootNode && e.getRootNode();
  ...
  function Ot(t) {
    for (let e = dt(t), i = Tt(t); i && wt(i) && "static" === yt(i).position; )
      i = Tt(i);
    return i &&
      ...
      : i ||
          (function (t) {
            let e = -1 !== navigator.userAgent.toLowerCase().indexOf("firefox");
            if (
        ...
        if (E) {
          if (o || a) {
            let k = "y" === y ? it : ot,
              ...
              X = E[y] + $ - V;
            if (o) {
              let Y = Dt(f ? Lt(S, K) : S, D, f ? kt(I, X) : I);
              (E[y] = Y), (C[y] = Y - D);
            }
            if (a) {
              let Q = "x" === y ? it : ot,
  ...
  let ae = { placement: "bottom", modifiers: [], strategy: "absolute" };
  function le() {
    for (let t = arguments.length, e = new Array(t), i = 0; i < t; i++)
      e[i] = arguments[i];
            ...
            return (
              ...
              a.orderedModifiers.forEach(function (t) {
                ...
                if ("function" == typeof s) {
                  let o = s({ state: a, name: e, instance: h, options: n });
                  l.push(o || function () {});
                }
              }),
              h.update()
