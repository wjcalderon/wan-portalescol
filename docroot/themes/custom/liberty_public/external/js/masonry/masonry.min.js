...
!(function (t, e) {
  ...
  (function (t, e) {
    ...
    function r(e) {
      if (
        ...
        for (
          let d = (a.isBorderBox = "border-box" == r.boxSizing), l = 0;
          u > l;
          l++
        ) {
          let c = h[l],
        ...
        let p = a.paddingLeft + a.paddingRight,
  ...
  (function (t, e) {
    ...
    (d.constructor = n),
      ...
      (d.layoutPosition = function () {
        ...
        let h = n ? "paddingTop" : "paddingBottom",
          u = n ? "top" : "bottom",
          d = n ? "bottom" : "top",
      ...
      (d.getTranslate = function (t, e) {
        let i = this.layout._getOption("originLeft"),
          n = this.layout._getOption("originTop");
        return (
          (t = i ? t : -t),
          (e = n ? e : -e),
    ...
    let c = { "-webkit-transform": "transform" };
  ...
  (function (t, e) {
    ...
    function r(t, e) {
      ...
      let r = this._getOption("initLayout");
      r && this.layout();
    }
    function s(t) {
      function e() {
    ...
    n.extend(f, e.prototype),
      ...
      (f._itemize = function (t) {
        for (
          let e = this._filterFindItemElements(t),
      ...
      (f.layout = function () {
        ...
        let t = this._getOption("layoutInstant"),
      ...
      (f._layoutItems = function (t, e) {
        if ((this._emitCompleteOnItems("layout", t), t && t.length)) {
          let i = [];
          t.forEach(function (t) {
            let n = this._getItemLayoutPosition(t);
  ...
  (function (t, e) {
    ...
    return (
      ...
      (n.getContainerWidth = function () {
        let t = this._getOption("fitWidth"),
      ...
      (n._getItemLayoutPosition = function (t) {
        ...
        for (
          let o = this.options.horizontalOrder
      ...
      (n._getTopColPosition = function (t) {
        let e = this._getTopColGroup(t),
          i = Math.min.apply(Math, e);
        return { col: e.indexOf(i), y: i };
      }),
      (n._getTopColGroup = function (t) {
        if (2 > t) return this.colYs;
        for (let e = [], i = this.cols + 1 - t, n = 0; i > n; n++)
      ...
      (n._getHorizontalColPosition = function (t, e) {
        let i = this.horizontalColIndex % this.cols,
          n = t > 1 && i + t > this.cols;
        i = n ? 0 : i;
        let o = e.size.outerWidth && e.size.outerHeight;
        return (
