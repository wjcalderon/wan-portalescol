/******/ (function (modules) {
  ...
  /******/ /******/ return __webpack_require__(
    (__webpack_require__.s = "./components/02-molecules/accordion/accordion.js")
  );
  /******/
})(
  /************************************************************************/
  ...
  \********************************************************/
      ...
      /***/ function (module, exports) {
        (function (a, b) {
          a.behaviors.accordion = {
            attach: function attach(a) {
              let c = b(
                  "yay-only-once",
                  a.querySelectorAll(".accordion__header")
                ),
                d = b("yay-only-once", a.querySelectorAll(".accordion"));
              Array.from(c).forEach(function (a) {
                a.addEventListener("click", function (a) {
                  let b = a.currentTarget,
                    c = b.closest(".accordion");
