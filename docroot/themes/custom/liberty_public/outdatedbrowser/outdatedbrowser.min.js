...
* @preserve
-----------------------------------------------------------------------*/
let outdatedBrowser = function (t) {
  function o(t) {
  ...
  function r() {
    let t = document.getElementById("btnCloseUpdateBrowser"),
  ...
  function n(t) {
    let o = document.getElementById("outdated");
    return (
      4 == t.readyState &&
        ((o.innerHTML =
  ...
  let s = document.getElementById("outdated");
  (this.defaultOpts = {
    bgColor: "#f25648",
    color: "#ffffff",
    lowerThan: "transform",
